"""
GLM-4.5V model implementation using vLLM backend with tensor parallelism.
...
Usage:
    ...
    python eval.py \
        ...
        --use_vllm --vllm_model_name glm-4.5v \
        ...
"""
...
class GLM4VVLLMModel(LLM):
    """GLM-4.5V model using vLLM backend with tensor parallelism."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        logger.info(f"[GLM4VVLLM] Connected to {self.vllm_base_url}, model={self.api_model_name}, thinking={self.enable_thinking}")
